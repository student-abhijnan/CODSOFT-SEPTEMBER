...
class todo:
    def __init__(self, root):
        ...
        self.root.geometry("650x500+400+100")
        ...
        self.label2 = Label(self.root, text='Add Task', 
                         font='ariel, 16 bold', width=10,bd=5, bg='orange', fg='black')
        ...
        self.main_text = Listbox(self.root, height=10, bd=5, width=20, font='ariel, 20 italic bold')
        ...
        def delete():
            ...
            with open('ToDo/data.txt', 'r+') as f:
                new_f = f.readlines()
                f.seek(0)
                for line in new_f:
                    item = str(look)
        ...
        with open('ToDo/data.txt', 'r') as file:
            read = file.readlines()
            for i in read:
                ready = i.split()
        ...
        self.button2 = Button(self.root, text='Delete', font='sarif, 30 bold italic',
